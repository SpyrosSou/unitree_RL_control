...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Path to standing policy checkpoint. If omitted, testing/walking_testing/checkpoints.yaml is used.",
)
parser.add_argument(
    "--walking_checkpoint",
    type=str,
    default=None,
    help="Path to walking policy checkpoint. If omitted, testing/walking_testing/checkpoints.yaml is used.",
)
